...
const FinishedBatteryPackScreen = () => {
    const finalisedBatteryPacks = useSelector((state)=>state.finalisedBatteryPacks);
        ...
        <ColContainer>
            <Row style={{
                ...
                <Typography style={{
                    ...
                    fontWeight: 600,
                    flex:1,
                }}>Available Battery Packs</Typography>
            ...
            <Row gutter={[12,20]}>
            {
                finalisedBatteryPacks.map((item,index)=>(
...
export default FinishedBatteryPackScreen